...
poewatcher_log = logging.getLogger("poewatcher")
poewatcher_log.setLevel(logging.DEBUG)
poewatcher_log.propagate = True
from poewatcher import log
poewatcher.log.dummy()
